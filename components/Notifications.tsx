...
const Notifications = () => {
  //destructuring the inboxnofications means it's a property coming from the useInboxNotifications
  ...
  return (
    <Popover>
      ...
      <PopoverContent align="end" className="shad-popover">
        <LiveblocksUIConfig
          // to have a simple way to figure out exactly what's happening through a specific notification
          overrides={{
